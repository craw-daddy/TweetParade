...
<!-- GENERATE DENIED TWEETS -->
        ...
        $result = $mysqli->query("SELECT * FROM `tweets` WHERE `reviewed` = 1 AND `approved` = 0 LIMIT 0, 20");
        ...
        echo "<h3>Reviewing Denied Tweets</h3>";
        echo "<form id='tweet_review_form' name='tweet_review' action='review-denied-tweets.php' method='POST'>";
        ...
        while($row = $result->fetch_assoc()) {
            ...
            //}
            echo "<div class=\"well well-sm\" style=\"background: #f2dede;\">";
            echo $row['text'];
            echo "</div>";
