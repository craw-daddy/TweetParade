...
<?php
    ...
    <div id="page-wrapper">
        ...
        $result = $mysqli->query("SELECT * FROM `tweets` WHERE `reviewed` = 0 AND `approved` = 0 LIMIT 0, 20");
        ...
        echo "<h3>Reviewing Pending Tweets</h3>";
        echo "<form id='tweet_review_form' name='tweet_review' action='review-pending-tweets.php' method='POST'>";
